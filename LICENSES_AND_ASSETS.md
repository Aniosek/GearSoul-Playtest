# Licencje i zasoby prototypowe

Kod źródłowy GearSoul nie jest publikowany w tym repozytorium. Publiczna paczka zawiera skompilowaną grę oraz dane spakowane przez Unreal Pak/IoStore.

## Zweryfikowane zasoby CC0

| Zasób | Autor | Źródło | Użycie |
|---|---|---|---|
| Textured LowPoly Trees | Quaternius | https://quaternius.itch.io/textured-lowpoly-trees | lekkie drzewa prototypowe; autor deklaruje brak generatywnej AI |
| Leafy Grass | Charlotte Baglioni / Poly Haven | https://polyhaven.com/a/leafy_grass | materiał terenu 1K |
| Survival Tools | Gar5546x | https://opengameart.org/content/survival-tools | prototypowe narzędzia po audycie siatki, materiałów i kolizji |
| Props Pack 1 | DREAM_SEARCH_REPEAT | https://opengameart.org/content/props-pack-1 | wyłącznie geometria chleba i kiełbas; nie używamy niezweryfikowanych materiałów fotograficznych |
